...
namespace mino::network_openssl::rest {
    ...
    void trace_client::set_server(const std::string& scheme, const std::string& host, long port, const std::string& path)
    {
    ...
    void trace_client::set_headers(const headers& headers) { headers_ = headers; }

    void trace_client::set_timeout_ms(long timeout_ms)
    {
