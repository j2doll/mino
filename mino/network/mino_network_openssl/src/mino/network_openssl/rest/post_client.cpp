...
namespace mino::network_openssl::rest {
    ...
    post_client::post_client() : impl_(std::make_unique<impl>()) {}
    post_client::~post_client() = default;

    void post_client::set_server(const std::string& scheme, const std::string& host, long port, const std::string& path)
    {
    ...
    void post_client::set_headers(const headers& headers) { headers_ = headers; }
    ...
    post_client::result_code post_client::post(const std::string& body_str, response& out_resp) noexcept
    {
