...
#include "mino/network_openssl/rest/head_client.hpp"

namespace mino::network_openssl::rest {

    struct head_client::impl
    {
        impl() = default;
        ~impl() = default;
    ...
    head_client::head_client() : impl_(std::make_unique<impl>()) {}
    head_client::~head_client() = default;

    void head_client::set_server(const std::string& scheme, const std::string& host, long port, const std::string& path)
    {
    ...
    void head_client::set_headers(const headers& headers) { headers_ = headers; }

    void head_client::set_timeout_ms(long timeout_ms)
    {
    ...
    head_client::response head_client::head(const query_params& q_params)
    {
        response resp;
        ...
        auto result = impl_->client_impl->Head(req_path, h);
        ...
        resp.body = ""; // HEAD method does not return body
    ...
    head_client::result_code head_client::head(const query_params& q_params, response& out_resp) noexcept
    {
        out_resp = head(q_params);
