...
namespace mino::network_curl::rest {
    ...
    public:
        ...
        // PATCH 요청 실행
        response patch(const std::string& body, const query_params& query_params = {});

        // PATCH 요청 실행 (result_code 반환)
        result_code patch(const std::string& body, response& out_resp, const query_params& query_params = {}) noexcept;
