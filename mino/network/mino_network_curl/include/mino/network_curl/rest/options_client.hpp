...
namespace mino::network_curl::rest {
    ...
    public:
        ...
        // OPTIONS 요청 실행
        response options(const query_params& query_params = {});

        // OPTIONS 요청 실행 (result_code 반환)
        result_code options(const query_params& query_params, response& out_resp) noexcept;
