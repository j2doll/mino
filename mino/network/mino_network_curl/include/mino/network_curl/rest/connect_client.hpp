...
namespace mino::network_curl::rest {
    ...
    public:
        ...
        // CONNECT 요청 실행
        response connect(const query_params& query_params = {});

        // CONNECT 요청 실행 (result_code 반환)
        result_code connect(const query_params& query_params, response& out_resp) noexcept;
