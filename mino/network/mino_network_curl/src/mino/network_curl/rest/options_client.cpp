...
#include "mino/network_curl/rest/options_client.hpp"
...
namespace mino::network_curl::rest {
    ...
    void options_client::global_init()
    {
    ...
    size_t options_client::write_callback(char* ptr, size_t size, size_t nmemb, void* userdata)
    {
    ...
    size_t options_client::header_callback(char* buffer, size_t size, size_t nitems, void* userdata)
    {
    ...
    bool options_client::set_server(const std::string& scheme,
    ...
    void options_client::set_headers(const headers& headers)
    {
        headers_ = headers;
    }

    bool options_client::set_timeout_ms(long timeout_ms)
    {
        if (timeout_ms <= 0)
            return false;
    ...
    std::vector<std::string> options_client::build_header_lines(const headers& headers)
    {
    ...
    options_client::http_status options_client::to_http_status(long code)
    {
        switch (code) {
    ...
    std::string options_client::build_url(const query_params& query_params)
    {
    ...
    options_client::response options_client::options(const query_params& query_params)
    {
        response resp;
        if (!curl_) {
    ...
    options_client::result_code options_client::classify(const response& r)
    {
        if (!r.error.empty()) {
    ...
    options_client::result_code
        options_client::options(const query_params& query_params, response& out_resp) noexcept
    {
        out_resp = options(query_params);
