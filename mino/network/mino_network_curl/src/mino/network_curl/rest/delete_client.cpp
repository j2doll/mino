...
#include "mino/network_curl/rest/delete_client.hpp"
...
namespace mino::network_curl::rest {
    ...
    void delete_client::global_init()
    {
    ...
    size_t delete_client::write_callback(char* ptr, size_t size, size_t nmemb, void* userdata)
    {
    ...
    size_t delete_client::header_callback(char* buffer, size_t size, size_t nitems, void* userdata)
    {
    ...
    void delete_client::set_headers(const headers& headers)
    {
        headers_ = headers;
    }

    bool delete_client::set_timeout_ms(long timeout_ms)
    {
        if (timeout_ms <= 0)
            return false;
    ...
    std::vector<std::string> delete_client::build_header_lines(const headers& headers)
    {
    ...
    delete_client::http_status delete_client::to_http_status(long code)
    {
        switch (code) {
    ...
    std::string delete_client::build_url(const query_params& query_params)
    {
    ...
    delete_client::response delete_client::del(const query_params& query_params, const std::string& body_str)
    {
        response resp;
        if (!curl_) {
    ...
    delete_client::result_code delete_client::classify(const response& r)
    {
        if (!r.error.empty()) {
    ...
    delete_client::result_code
        delete_client::del(const query_params& query_params, const std::string& body, response& out_resp) noexcept
    {
        out_resp = del(query_params, body);
