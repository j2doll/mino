...
bool test_tcp_ipv4() {
    ...
    namespace mnr = mino::network_openssl::redis;
    using redis_tcp_client = mnr::redis_tcp_client;

    redis_tcp_client client;
...
bool test_tls_client() {
    ...
    namespace mnr = mino::network_openssl::redis;
    using redis_tls_client = mnr::redis_tls_client;

    redis_tls_client client;

    mnr::redis_tls_config tls_config;
