...
#include "mino/network_curl/socket-io/socketio_client.hpp"

bool g_keep_running = true; // 프로그램 종료를 위한 전역 플래그
mino::network_curl::socket_io::socketio_client_base* g_active_client = nullptr; // 현재 활성화된 Socket.IO 클라이언트 포인터
...
int main(int argc, char* argv[]) {
    ...
    namespace sio = mino::network_curl::socket_io;
    namespace dtutil = mino::core::datetime::util;
